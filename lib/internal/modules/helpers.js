...
const {
  ...
  getTranspiledCachedModule: _getTranspiledCachedModule,
  setTranspiledCachedModule: _setTranspiledCachedModule,
...
function getTranspiledCachedModule(source, filename) {
  const result = _getTranspiledCachedModule(source, filename);
  process._rawDebug(result);
  const { 0: cache, 1: file } = result;
  return {
    cache,
    file,
  };
...
function setTranspiledCachedModule(source, filename) {
  const { 0: cache, 1: file } = _setTranspiledCachedModule(source, filename);
  return {
    cache,
    file,
  };
...
module.exports = {
  ...
  getCjsConditions,
  getCompileCacheDir,
  getTranspiledCachedModule,
  initializeCjsConditions,
  isUnderNodeModules,
  loadBuiltinModule,
  makeRequireFunction,
  normalizeReferrerURL,
  setTranspiledCachedModule,
